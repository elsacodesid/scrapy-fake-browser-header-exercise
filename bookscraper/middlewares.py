...
class ScrapeOpsFakeBrowserHeaderMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_endpoint = settings.get("SCRAPEOPS_FAKE_BROWSER_HEADER_ENDPOINT", "http://headers.scrapeops.")
    ...
    def process_request(self, request, spider):
        ...
        request.headers["sec-chp-ua"] = random_browser_header["sec-ch-ua"]
